                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('region') ? ' has-error' : '' }}">
                            <label for="region" class="col-md-4 control-label">* Género</label>
                        ...
                        <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                {{ Form::select('pais',['Argentina','Bolivia','Chile','Colombia','Ecuador','Paraguay','Uruguay','Venezuela'],0,array('class'=>'form-control','id'=>'pais','name'=>'country','required','autofocus')) }}
                        ...
                        <div class="form-group{{ $errors->has('region') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                {{ Form::select('region',['Arica','Antofagasta','Atacama','Coquimbo','Valparaiso','Rancagua','OHiggins','Curicó'],0,array('class'=>'form-control','id'=>'region','name'=>'region','required','autofocus')) }}
                        ...
                        <div class="form-group{{ $errors->has('Commune') ? ' has-error' : '' }}">
                            <label for="Commune" class="col-md-4 control-label">* Comuna/Municipio</label>

                            <div class="col-md-6">
                                
                                {{ Form::select('region',['Coquimbo','La Serena','Andacollo','Vicuña','Ovalle','La Higuera'],0,array('class'=>'form-control','id'=>'Commune','name'=>'Commune','required','autofocus')) }}
